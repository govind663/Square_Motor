...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Company Leadger</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">All Company Leadger List</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" class="col-sm-12" action="{{ route('company_to_company.search_company_wise_tranx') }}" enctype="multipart/form-data" autocomplete="off" >
                            @csrf
                                    ...
                                    <div class="col-lg-3 col-md-12 col-sm-12">
                                        <div class="input-block mb-3" >
                                            ...
                                            <select  class="form-control @error('insurance_company_id') is-invalid @enderror select" id="insurance_company_id" name="insurance_company_id">
                                                ...
                                                @foreach ($insuraanceCompany as $value )
                                                <option value="{{ $value->id }}" {{ (old('insurance_company_id', request('insurance_company_id')) == $value->id ? "selected":"") }}>{{ $value->company_name }}</option>
                                                @endforeach
                                            </select>
                        ...
                        <div class="table-responsive">
                            <table class="data-table-export1 table table-hover">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($companyDebitCreditLog as $key => $value)
                                    <tr>
                                        <td>{{ ++$key }}</td>
