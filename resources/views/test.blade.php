...
<head>
    ...
    <script src="assets/js/layout.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>
</head>
...
<body>
            ...
            <ul class="nav nav-tabs user-menu">
                ...
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)" class="user-link  nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img src="assets/img/profiles/avatar-20.jpg" alt="img" class="profilesidebar">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                        ...
                        <ul class="list-inline-item list-unstyled links">
                            ...
                            <li class="submenu">
                                <a href="#"><i class="fe fe-users"></i><span>Customers</span> <span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="customers.html" class="active"><i class="fe fe-users"></i>
                    ...
                    <ul class="sidebar-vertical">
                        ...
                        <li>
                            <a href="customers.html" class="active"><i class="fe fe-users"></i>
    ...
    <head>
        ...
        <meta property="og:image:secure_url"
            content="https://kanakku.dreamstechnologies.com/assets/img/kanakku.jpg">
        <meta property="og:image:type" content="image/png">
        <meta property="og:image:width" content="1200">
        <meta property="og:image:height" content="600">
        <title>Kanakku - Bootstrap Admin HTML Template</title>
        ...
        <script src="assets/js/layout.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>
    </head>
    ...
    <body>
            ...
            <div class="header header-one">
                ...
                <div class="main-logo d-inline float-start d-lg-flex align-items-center d-none d-sm-none d-md-none">
                    <div class="logo-white">
                        ...
                        <a href="index.html">
                            <img src="assets/img/logo-small-white.png" class="img-fluid logo-small"
                                alt="Logo">
                        </a>
                    </div>
                    <div class="logo-color">
                ...
                <ul class="nav nav-tabs user-menu">
                    ...
                    <li class="nav-item dropdown  flag-nav dropdown-heads">
                        ...
                        <div class="dropdown-menu notifications">
                            <div class="topnav-dropdown-header">
                                <div class="notification-title">Notifications <a href="notifications.html">View
                                        all</a></div>
                                    ...
                                    <li class="notification-message">
                                        <a href="profile.html">
                                            <div class="d-flex">
                                                ...
                                                <div class="media-body">
                                                    <p class="noti-details"><span class="noti-title">Lex
                                                            Murphy</span> requested access to <span
                                                            class="noti-title">UNIX directory tree hierarchy</span>
                                                    </p>
                                                    <div class="notification-btn">
                                                        <span class="btn btn-primary">Accept</span>
                                                        <span class="btn btn-outline-primary">Reject</span>
                                    ...
                                    <li class="notification-message">
                                        <a href="profile.html">
                                            <div class="d-flex">
                                                ...
                                                <div class="media-body">
                                                    <p class="noti-details"><span class="noti-title">Ray
                                                            Arnold</span> left 6 comments <span class="noti-title">on
                                                            Isla Nublar SOC2 compliance report</span></p>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="media-body">
                                                    <p class="noti-details"><span class="noti-title">John
                                                            Hammond</span> created <span class="noti-title">Isla
                                                            Nublar SOC2 compliance report</span></p>
                    ...
                    <div id="sidebar-menu" class="sidebar-menu">
                        <nav class="greedys sidebar-horizantal">
                            <ul class="list-inline-item list-unstyled links">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="vendors.html"><i class="fe fe-user"></i>
                                                <span>Vendors</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-title"><span>Inventory</span></li>
                                <li class="submenu">
                                    <a href="#"><i class="fe fe-package"></i> <span> Products /
                                ...
                                <li class="submenu">
                                    <a href="#"><i class="fe fe-file-plus"></i><span>Signature</span> <span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="signature-list.html"><i class="fe fe-clipboard"></i> <span>List
                                                    of Signature</span></a></li>
                                        <li><a href="signature-invoice.html"><i class="fe fe-box"></i>
                                                <span>Signature Invoice</span></a></li>
                                    </ul>
                                </li>
                                <li class="menu-title"><span>Sales</span></li>
                                <li class="submenu">
                            ...
                            <ul class="hidden-links hidden">
                                ...
                                <li>
                                    <a href="credit-notes.html"><i class="fe fe-edit"></i> <span>Credit
                                            Notes</span></a>
                                </li>
                                <li class="menu-title"><span>Purchases</span></li>
                                <li>
                                ...
                                <li class="menu-title"><span>Finance & Accounts</span></li>
                                <li>
                                    <a href="expenses.html"><i class="fe fe-file-plus"></i>
                                        <span>Expenses</span></a>
                                </li>
                                <li>
                                    <a href="payments.html"><i class="fe fe-credit-card"></i>
                                ...
                                <li>
                                    <a href="error-404.html"><i class="fe fe-x-square"></i> <span>Error
                                            Pages</span></a>
                                </li>
                                <li>
                                    <a href="blank-page.html"><i class="fe fe-file"></i> <span>Blank Page</span></a>
                                ...
                                <li>
                                    <a href="maps-vector.html"><i class="fe fe-image"></i> <span>Vector
                                            Maps</span></a>
                                </li>
                                <li class="menu-title">
                                    <span>UI Interface</span>
                                ...
                                <li>
                                    <a href="javascript:void(0);"><i class="fe fe-lock"></i> <span>Change Log</span>
                                        <span class="badge badge-primary ms-auto">v2.0.4</span></a>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);"><i class="fa fa-list"></i> <span>Multi
                        ...
                        <ul class="sidebar-vertical">
                            ...
                            <li class="menu-title"><span>Sales</span></li>
                            <li class="submenu">
                                <a href="#" class><i class="fe fe-file"></i> <span>Invoices</span><span
                                        class="menu-arrow"></span></a>
                                <ul style="display: none;">
                                    <li><a href="invoices.html">Invoices List</a></li>
                                    <li><a href="invoice-details-admin.html">Invoice Details (Admin)</a></li>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="d-flex justify-content-between flex-wrap">
                                                    <div class="input-block mb-3 recurring-tab">
                                                        ...
                                                        <ul class="nav nav-pills d-flex" id="pills-tab"
                                                            role="tablist">
                                                            <li class="nav-item" role="presentation">
                                                                <button class="nav-link active yes"
        ...
        <div class="settings-icon">
            <span data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas"
                aria-controls="theme-settings-offcanvas"><img src="assets/img/icons/siderbar-icon2.svg"
        ...
        <div class="offcanvas offcanvas-end border-0 " tabindex="-1" id="theme-settings-offcanvas">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-check card-radio p-0 ">
                                        ...
                                        <label class="form-check-label avatar-md w-100 px-2"
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-check sidebar-setting card-radio p-0 ">
                                        ...
                                        <label class="form-check-label avatar-md w-100"
            ...
            <div class="offcanvas-footer border-top p-3 text-center">
                <div class="row">
                    <div class="col-6">
                        <button type="button" class="btn btn-light w-100 bor-rad-50"
        ...
        <script src="assets/js/jquery-3.7.1.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/js/bootstrap.bundle.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/plugins/datatables/datatables.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/plugins/select2/js/select2.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/plugins/moment/moment.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>
        <script src="assets/js/bootstrap-datetimepicker.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/js/jquery-ui.min.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/js/theme-settings.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>
        <script src="assets/js/greedynav.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>

        <script src="assets/js/script.js" type="b057472ca793bbdbb35c7222-text/javascript"></script>
        <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
            data-cf-settings="b057472ca793bbdbb35c7222-|49" defer></script>
    </body>
    ...
    <script src="assets/js/jquery-3.7.1.min.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>

    <script src="assets/js/bootstrap.bundle.min.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>

    <script src="assets/js/feather.min.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>

    <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>

    <script src="assets/plugins/select2/js/select2.min.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>

    <script src="assets/plugins/intlTelInput/js/intlTelInput-jquery.min.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>

    <script src="assets/js/theme-settings.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>
    <script src="assets/js/greedynav.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>

    <script src="assets/js/script.js" type="6d1bc1190f8092ff34f8948a-text/javascript"></script>
    <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="6d1bc1190f8092ff34f8948a-|49" defer></script>
</body>
