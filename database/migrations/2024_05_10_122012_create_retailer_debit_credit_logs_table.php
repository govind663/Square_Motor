...
return new class extends Migration
{
    ...
    {
        Schema::create('retailer_debit_credit_logs', function (Blueprint $table) {
            $table->id();
            $table->date('tranx_dt')->nullable();
            $table->foreignIdFor(Retailer::class)->nullable()->constrained()->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('retailer_debit_credit_logs');
    }
};
